...
export default function SciencesPage() {
	...
	return (
		<div className="max-w-3xl mx-auto py-10 px-4">
			...
			<h1 className="text-3xl font-bold mb-8">Sciences UBC Test</h1>
				...
				<section>
					...
					<div className="pl-4 py-2 mb-8 text-center">
						...
						<div className="text-gray-700">
							You've done {selected.length} out of {SCIENCES.length} items on
							this list.
						</div>
					</div>
					...
					<section className="mb-8">
						<div className="p-4 rounded-md border">
							<div className="text-right mb-4">
								<span className="border px-3 py-1 rounded-full text-sm font-medium">
									Selected: {selected.length}/{SCIENCES.length}
								</span>
							</div>

							<ul className="space-y-2">
								{SCIENCES.map((prompt, i) => (
									<li
										key={prompt}
										className="flex items-center gap-3 hover:opacity-80 p-2 rounded transition"
									>

...
const ENGINEERING = [
  // ACADEMIC LIFE (20 questions)
  "Failed a first-year calculus course",
  "Switched engineering disciplines because of a failed course",
  "Pulled an all-nighter in the Engineering Student Centre (ESC)",
  "Crammed an entire semester's worth of material the night before the final",
  "Slept less than 4 hours for an entire week during finals season",
  "Gotten less than 50% on a midterm and still passed the course",
  "Submitted a lab report 30 seconds before the deadline",
  "Attended a lecture just to use the clicker for attendance",
  "Skipped more than half the lectures for a core course",
  "Accidentally submitted the wrong file for an assignment",
  "Completed an assignment during another lecture",
  "Studied for over 12 hours straight in Kaiser",
  "Written an exam with a fever because you couldn't miss it",
  "Calculated the minimum final exam grade needed to pass",
  "Been caught copying code for a programming assignment",
  "Forgotten to bring your calculator to a math exam",
  "Missed an exam because you overslept",
  "Had a group project where you did all the work",
  "Been called out by a professor for being on your phone in class",
  "Taken an 'easy' elective and still barely passed",

  // ENGINEERING BUILDINGS & SPACES (15 questions)
  "Had a mental breakdown in a Kaiser bathroom",
  "Spent more than 24 consecutive hours in CEME",
  "Slept on the couches in the ESC",
  "Found a secret study spot in the depths of the CHBE building",
  "Been kicked out of a building for studying too late",
  "Used the showers in any engineering building",
  "Had to run from Kaiser to Buchanan in under 10 minutes for back-to-back classes",
  "Studied in the MacLeod Building basement",
  "Found century-old graffiti in the CEME",
  "Spent so much time in the Engineering Design Centre that staff knew you by name",
  "Complained about the lack of power outlets in any engineering building",
  "Used the microwave in the Cheeze so many times you broke it",
  "Spent an entire weekend in the Engineering Design Centre",
  "Had food delivered to an engineering building after hours",
  "Claimed a lab computer as 'yours' for an entire term",

  // ENGINEERING CULTURE & TRADITIONS (20 questions)
  "Defended the Cairn from being defaced",
  "Participated in defacing the Cairn (if you're not an engineer)",
  "Helped paint the Cairn red (if you are an engineer)",
  "Participated in E-Week",
  "Been to an EUS Council meeting",
  "Attended the Great Gear-Off",
  "Participated in tricking first years into thinking there's a pool on top of Kaiser",
  "Dyed the fountain red (or been involved in planning it)",
  "Helped with a major engineering prank",
  "Attended an Engineering Boat Cruise",
  "Been to the annual EUS Retreat",
  "Taken part in the Rube Goldberg competition",
  "Worn your Red jacket to a non-engineering event",
  "Explained what E-Week is to a non-engineering student",
  "Participated in the Concrete Toboggan or Concrete Canoe competition",
  "Been involved with a departmental club (CHIUS, MECH Club, etc.)",
  "Been escorted off campus because of an engineering prank",
  "Bought something from Red Sales",
  "Tried explaining the Cairn's significance to a non-UBC person",
  "Participated in the engineer's Ball",

  // ENGINEERING RITES OF PASSAGE (10 questions)
  "Pulled an all-nighter for a design project",
  "Received your Iron Ring",
  "Bought your Red engineering jacket",
  "Had your Red jacket stolen",
  "Been called an 'eng-nerd' by someone outside engineering",
  "Attended the Iron Ring ceremony",
  "Added patches to your Red jacket",
  "Written an exam with less than 2 hours of sleep",
  "Fixed something in your house using 'engineering skills'",
  "Joined the engineering drinking team",

  // SOCIAL LIFE & DATING (15 questions)
  "Dated someone from your program",
  "Had a crush on someone in your design team",
  "Used 'I'm an engineering student' as an excuse for being late",
  "Used 'I study engineering' as a pickup line",
  "Hooked up with someone from another engineering discipline",
  "Formed a study group that became your core friend group",
  "Flirted with someone by helping them with their engineering homework",
  "Had a tinder match recognize you from an engineering class",
  "Missed a date because you were stuck finishing a lab report",
  "Met your significant other in an engineering class",
  "Dated someone and then had to awkwardly work with them on a group project",
  "Recognized someone from your 200-person lecture at a party",
  "Had to explain to your date why you can't go out during midterm week",
  "Been stood up because your date was finishing an engineering assignment",
  "Been in a relationship with a non-engineering student who didn't understand your schedule",

  // ENGINEERING STUDENT STEREOTYPES (15 questions)
  "Worn sweatpants to class for a week straight",
  "Corrected someone's physics in a movie",
  "Had a meal plan consisting mostly of instant ramen",
  "Carried around a scientific calculator at all times 'just in case'",
  "Owned a TI-84 calculator worth more than your textbook",
  "Bragged about how little sleep you've gotten",
  "Said 'that's just a simple physics problem' unironically",
  "Been embarrassingly excited about a new tech gadget",
  "Had a mental breakdown about your future career options",
  "Owned multiple identical plain t-shirts to save decision-making energy",
  "Referred to a difficult homework problem as 'trivial' after solving it",
  "Explained a complex engineering concept at a party when nobody asked",
  "Wore socks with sandals to class",
  "Built something unnecessarily complex to solve a simple problem",
  "Questioned the structural integrity of a building you were in",

  // STUDY HABITS & COPING MECHANISMS (15 questions)
  "Consumed dangerous amounts of caffeine during finals season",
  "Created an elaborate study schedule that you abandoned after two days",
  "Developed a caffeine tolerance that would concern medical professionals",
  "Done integration practice at 3am",
  "Calculated the exact minimum grade needed on the final to pass",
  "Started an assignment the night before it was due",
  "Used the excuse 'I'm an engineering student' to justify unhealthy habits",
  "Eaten a meal consisting entirely of vending machine food",
  "Skipped multiple meals because you were studying",
  "Used the UBC Wellness Centre services because of academic stress",
  "Claimed to thrive under pressure to justify procrastination",
  "Stayed on campus overnight because you missed the last bus",
  "Made study notes on random scraps of paper because you ran out of notebooks",
  "Listened to the same song on repeat for an entire study session",
  "Used a whiteboard to solve equations during a party",

  // DESIGN TEAMS & PROJECTS (10 questions)
  "Joined a design team but barely contributed",
  "Been part of UBC Formula, Orbit, or another competitive design team",
  "Spent more money on a design project than you budgeted for",
  "Broken expensive lab equipment during a project",
  "Realized your design had a fundamental flaw the day before presentation",
  "Had a prototype completely fail during a demonstration",
  "Pulled an all-nighter to finish a design project on time",
  "Had your project win an engineering competition",
  "Had to restart a design from scratch days before the deadline",
  "Made up data in a project report because your experiment failed",

  // CAREER & FUTURE PROSPECTS (10 questions)
  "Gotten a co-op position in your dream field",
  "Failed to get any interviews despite applying to 50+ positions",
  "Written a cover letter so generic it could apply to any company",
  "Added projects to your resume that you barely worked on",
  "Stressed about not having enough extracurriculars for your resume",
  "Attended a networking event just for the free food",
  "Changed your career aspirations completely because of one course",
  "Considered graduate school to avoid entering the job market",
  "Practiced technical interview questions when you should have been studying",
  "Worried about your GPA being too low for job applications",

  // EPIC ENGINEERING MOMENTS (10 questions)
  "Participated in Storm the Wall as an engineering team",
  "Been part of a legendary UBC engineering prank",
  "Helped hang something from a campus building as a prank",
  "Successfully defended the Cairn during rivalry week",
  "Attended the legendary EUS Boat Cruise party",
  "Completed the 'Great Engineering Challenge' during E-Week",
  "Won a prize at an engineering competition",
  "Helped plan a massive engineering social event",
  "Been recognized by a professor for exceptional work",
  "Created something in a lab that the professor kept as an example",
];

export { ENGINEERING, GENERAL, SCIENCES, SAUDER, ARTS };
